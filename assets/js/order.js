    ...
    products.forEach(product => { 
        ...
        (function(){
            ...
            (function(){
                ...
                thisAllPrice = parseFloat(thisPriseInfo.replace("$", "")) * ${product.quantity};
                totalAllPrice =  totalAllPrice + thisAllPrice;
            }());      
            if(${product.sale}){
                thisProduct.classList.add('sale');
                ...
                const result = allOldPrice * ${product.quantity};
...
function functionBasket(){
    const basketPrice = document.querySelector('#total-price');
    basketPrice.innerHTML = '$' + totalAllPrice;
};

function discount(){
    discountPrice.innerHTML = totalDiscount;
}

function totalPriceAll(){
    allPrice.innerHTML = "$" + (totalAllPrice - totalDiscount).toFixed(2);
}
