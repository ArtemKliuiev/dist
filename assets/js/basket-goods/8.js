setTimeout(function(){
    // JavaScript код
    const goodsInfo = 'item8';
    const thisUrl = '/dist/basket-goods/minerals/1.html';
    const thisScript = '/assets/js/basket-goods/8.js';
    const thisProduct = document.querySelector('#product8')
    ...
    const check = thisProduct.querySelector('#check8');
