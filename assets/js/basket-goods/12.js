setTimeout(function(){
    // JavaScript код
    const goodsInfo = 'item12';
    const thisUrl = '/dist/basket-goods/vitamins/7.html';
    const thisScript = '/assets/js/basket-goods/12.js';
    const thisProduct = document.querySelector('#product12')
    ...
    const check = thisProduct.querySelector('#check12');
