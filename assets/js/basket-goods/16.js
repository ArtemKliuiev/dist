setTimeout(function(){
    // JavaScript код
    const goodsInfo = 'item16';
    const thisUrl = '/dist/basket-goods/minerals/5.html';
    const thisScript = '/assets/js/basket-goods/16.js';
    const thisProduct = document.querySelector('#product16')
    ...
    const check = thisProduct.querySelector('#check16');
