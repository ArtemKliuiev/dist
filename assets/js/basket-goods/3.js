setTimeout(function(){
    ...
    const thisUrl = '/dist/basket-goods/vitamins/3.html';
    const thisScript = '/assets/js/basket-goods/3.js';
    const thisProduct = document.querySelector('#product3')
    ...
    const check = thisProduct.querySelector('#check3');
