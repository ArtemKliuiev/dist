setTimeout(function(){
    // JavaScript код
    const goodsInfo = 'item20';
    const thisUrl = '/dist/basket-goods/probiotics/1.html';
    const thisScript = '/assets/js/basket-goods/20.js';
    const thisProduct = document.querySelector('#product20')
    ...
    const check = thisProduct.querySelector('#check20');
