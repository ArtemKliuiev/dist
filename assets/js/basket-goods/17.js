setTimeout(function(){
    // JavaScript код
    const goodsInfo = 'item17';
    const thisUrl = '/dist/basket-goods/vitamins/10.html';
    const thisScript = '/assets/js/basket-goods/17.js';
    const thisProduct = document.querySelector('#product17')
    ...
    const check = thisProduct.querySelector('#check17');
