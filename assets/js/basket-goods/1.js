setTimeout(function(){
    // JavaScript код
    const goodsInfo = 'item1';
    const thisUrl = '/dist/basket-goods/vitamins/1.html';
    const thisScript = '/assets/js/basket-goods/1.js';
    const thisProduct = document.querySelector('#product1')
    ...
    const check = thisProduct.querySelector('#check1');
