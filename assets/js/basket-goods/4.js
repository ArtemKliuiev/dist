setTimeout(function(){
    // JavaScript код
    const goodsInfo = 'item4';
    const thisUrl = '/dist/basket-goods/vitamins/4.html';
    const thisScript = '/assets/js/basket-goods/4.js';
    const thisProduct = document.querySelector('#product4')
    ...
    const check = thisProduct.querySelector('#check4');
