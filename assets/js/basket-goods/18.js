setTimeout(function(){
    // JavaScript код
    const goodsInfo = 'item18';
    const thisUrl = '/dist/basket-goods/vitamins/11.html';
    const thisScript = '/assets/js/basket-goods/18.js';
    const thisProduct = document.querySelector('#product18')
    ...
    const check = thisProduct.querySelector('#check18');
