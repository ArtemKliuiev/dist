setTimeout(function(){
    // JavaScript код
    const goodsInfo = 'item14';
    const thisUrl = '/dist/basket-goods/vitamins/8.html';
    const thisScript = '/assets/js/basket-goods/14.js';
    const thisProduct = document.querySelector('#product14')
    ...
    const check = thisProduct.querySelector('#check14');
