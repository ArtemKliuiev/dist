setTimeout(function(){
    // JavaScript код
    const goodsInfo = 'item7';
    const thisUrl = '/dist/basket-goods/sale/1.html';
    const thisScript = '/assets/js/basket-goods/7.js';
    const thisProduct = document.querySelector('#product7')
    ...
    const check = thisProduct.querySelector('#check7');
