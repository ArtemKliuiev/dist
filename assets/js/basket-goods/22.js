setTimeout(function(){
    // JavaScript код
    const goodsInfo = 'item22';
    const thisUrl = '/dist/basket-goods/pain/1.html';
    const thisScript = '/assets/js/basket-goods/22.js';
    const thisProduct = document.querySelector('#product22')
    ...
    const check = thisProduct.querySelector('#check22');
