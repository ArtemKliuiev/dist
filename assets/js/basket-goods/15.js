setTimeout(function(){
    // JavaScript код
    const goodsInfo = 'item15';
    const thisUrl = '/dist/basket-goods/vitamins/9.html';
    const thisScript = '/assets/js/basket-goods/15.js';
    const thisProduct = document.querySelector('#product15')
    ...
    const check = thisProduct.querySelector('#check15');
