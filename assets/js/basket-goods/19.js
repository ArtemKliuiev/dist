setTimeout(function(){
    // JavaScript код
    const goodsInfo = 'item19';
    const thisUrl = '/dist/basket-goods/antioxidants/1.html';
    const thisScript = '/dist/assets/js/basket-goods/19.js';
    const thisProduct = document.querySelector('#product19')
    ...
    const check = thisProduct.querySelector('#check19');
