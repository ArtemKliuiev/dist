setTimeout(function(){
    // JavaScript код
    const goodsInfo = 'item13';
    const thisUrl = '/dist/basket-goods/minerals/4.html';
    const thisScript = '/assets/js/basket-goods/13.js';
    const thisProduct = document.querySelector('#product13')
    ...
    const check = thisProduct.querySelector('#check13');
