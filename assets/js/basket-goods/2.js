setTimeout(function(){
    // JavaScript код
    const goodsInfo = 'item2';
    const thisUrl = '/dist/basket-goods/vitamins/2.html';
    const thisScript = '/assets/js/basket-goods/2.js';
    const thisProduct = document.querySelector('#product2')
    ...
    const check = thisProduct.querySelector('#check2');
