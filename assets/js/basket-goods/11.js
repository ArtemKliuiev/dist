setTimeout(function(){
    // JavaScript код
    const goodsInfo = 'item11';
    const thisUrl = '/dist/basket-goods/vitamins/6.html';
    const thisScript = '/assets/js/basket-goods/11.js';
    const thisProduct = document.querySelector('#product11')
    ...
    const check = thisProduct.querySelector('#check11');
