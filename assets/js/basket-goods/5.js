setTimeout(function(){
    // JavaScript код
    const goodsInfo = 'item5';
    const thisUrl = '/dist/basket-goods/weight/1.html';
    const thisScript = '/assets/js/basket-goods/5.js';
    const thisProduct = document.querySelector('#product5')
    ...
    const check = thisProduct.querySelector('#check5');
