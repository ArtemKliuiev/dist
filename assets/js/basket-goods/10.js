setTimeout(function(){
    // JavaScript код
    const goodsInfo = 'item10';
    const thisUrl = '/dist/basket-goods/minerals/3.html';
    const thisScript = '/assets/js/basket-goods/10.js';
    const thisProduct = document.querySelector('#product10')
    ...
    const check = thisProduct.querySelector('#check10');
