setTimeout(function(){
    // JavaScript код
    const goodsInfo = 'item6';
    const thisUrl = '/dist/basket-goods/vitamins/5.html';
    const thisScript = '/assets/js/basket-goods/6.js';
    const thisProduct = document.querySelector('#product6')
    ...
    const check = thisProduct.querySelector('#check6');
